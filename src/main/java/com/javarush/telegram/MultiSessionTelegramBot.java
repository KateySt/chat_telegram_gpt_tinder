...
public class MultiSessionTelegramBot extends TelegramLongPollingBot {
    ...
    /**
     * Method returns the text from the latest Telegram message
     */
    ...
    /**
     * Method returns the button key (buttonKey) that was pressed.
     * This refers to buttons added to the message.
     */
     ...
     * The image is specified by the photoKey.
    ...
    /**
     * Method sends a PHOTO (Image) and TEXT to the chat.
     * The image is specified by the photoKey.
     * All images are located in the resources/images folder.
     */
    ...
    /**
     * Method updates the TEXT in a previously sent message.
     */
    ...
    public void showMainMenu(String... commands) {
        ...
        // ignore command changes for the same list
